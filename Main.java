...
public class Main {
    public static void main(String[] args) {
        ...
        RenderEngine highlightEngine;
        highlightEngine = new HighlightRenderEngine();
